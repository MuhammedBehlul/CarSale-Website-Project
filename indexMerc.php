...
.car {
    width: 100%; /* Adjust width to take full column width */
...
<body>
    ...
    <div class="car-container">
        <div class="car">
            <a href="carsmerc1.php"> <img src="Images\redg1.jpg" alt="Mercedes G-Class"></a>
            <div class="car-info">
                <h2>Mercedes G</h2>
                <p>$150,000.00</p>
            </div>
        ...
        <div class="car">
            <a href="carsmerc3.php"> <img src="Images\slindex.jpg" alt="Mercedes SL"></a>
            <div class="car-info">
                <h2>Mercedes SL</h2>
                <p>$110,000.00</p>
            </div>
        ...
        <div class="car">
            <a href="carsmerc2.php"> <img src="Images\gtblue.png" alt="Mercedes GTS"></a>
            <div class="car-info">
                <h2>Mercedes GTS</h2>
                <p>$220,000.00</p>
            </div>
        ...
        <div class="car">
            <a href="carsmerc4.php"> <img src="Images\clablue.png" alt="Mercedes CLA"></a>
            <div class="car-info">
                <h2>Mercedes CLA</h2>
                <p>$40,000.00</p>
            </div>
