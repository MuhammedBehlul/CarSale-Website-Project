...
<body>
    ...
    <div class="car-container">
        <div class="car">
            <a href="carsbmw1.php"> <img src="Images\i5black.jpg" alt="BMW i5"></a>
            <div class="car-info">
                <h2>BMW i5</h2>
                <p>$70,000.00</p>
            </div>
        ...
        <div class="car">
            <a href="carsbmw2.php"> <img src="Images\x7black.jpg" alt="BMW X7"></a>
            <div class="car-info">
                <h2>BMW X7</h2>
                <p>$130,000.0</p>
            </div>
        ...
        <div class="car">
            <a href="carsbmw3.php"> <img src="Images\i4black.jpg" alt="BMW i4"></a>
            <div class="car-info">
                <h2>BMW i4</h2>
                <p>$45,000.0</p>
            </div>
        ...
        <div class="car">
            <a href="carsbmw4.php"> <img src="Images\430black.jpg" alt="BMW 430i"></a>
            <div class="car-info">
                <h2>BMW 430i</h2>
                <p>$65,000.00</p>
            </div>
