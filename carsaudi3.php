...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['purchase'])) {
    ...
    $sql = "INSERT INTO purchased_cars (username, color, engine, seat, carbonfiber, wheels, purchasedate, brand, model) 
            VALUES ('$username', '$color', '$engine', '$seat', '$carbonfiber', '$wheels', '$time', 'Audi', 'Q3')";
...
<body>
    ...
    <div class="container">
        <div class="car-picture" id="car-picture">
            ...
            <img src="Images/q3blue.jpg" alt="Car Image">
        </div>
        <div class="customization-form">
            <h2>Customize Your Car</h2>
            <form method="post" action="carsaudi3.php">
...
    }
    ...
    function changeCarPicture() {
        ...
        if (selectedColor === "red") {
            carImageSrc = "Images/q3red.jpg";
        } else if (selectedColor === "blue") {
            carImageSrc = "Images/q3blue.jpg";
        } else if (selectedColor === "black") {
            carImageSrc = "Images/q3black.jpg";
        }
