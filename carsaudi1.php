...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['purchase'])) {
    ...
    $sql = "INSERT INTO purchased_cars (username, color, engine, seat, carbonfiber, wheels, purchasedate, brand, model)  VALUES ('$username', '$color', '$engine', '$seat', '$carbonfiber', '$wheels', '$time', 'Audi', 'etron')";
...
<body>
    ...
    <div class="container">
        <div class="car-picture" id="car-picture">
            ...
            <img src="Images/etronblue.jpg" alt="Car Image">
        </div>
        <div class="customization-form">
            <h2>Customize Your Car</h2>
            <form method="post" action="carsaudi1.php">
                ...
                <label for="amg"><input type="checkbox" id="amg" name="amg" value="amg"> QUATRO Package (+$5,000)</label>
            ...
            <div id="price-tag">Base Price: $50,000</div>
        </div>
    </div>
...
    }
    ...
    function changeCarPicture() {
        ...
        if (selectedColor === "red") {
            carImageSrc = "Images/etronred.jpg";
        } else if (selectedColor === "blue") {
            carImageSrc = "Images/etronblue.jpg";
