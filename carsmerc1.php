...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['purchase'])) {
 ...
 $conn = mysqli_connect($db_host, $db_user, $db_pass, $db_name);
    ...
    $sql = "INSERT INTO purchased_cars (username, color, engine, seat, carbonfiber, wheels, purchasedate, brand, model) VALUES ('$username', '$color', '$engine', '$seat', '$carbonfiber', '$wheels', '$time', 'Mercedes', 'G')";
...
<body>
        ...
        <li><a href="index.php">Home</a></li>
            <li>
                ...
                <div class="dropdown-content">
                    <a style= "font-size:1rem;"href="indexBMW.php">BMW</a>
                    <a style= "font-size:1rem;"href="indexMerc.php">Mercedes</a>
                    <a style= "font-size:1rem;"href="indexAudi.php">Audi</a>
                </div>
            </li>
    ...
    <div class="container">
        <div class="car-picture" id="car-picture">
            ...
            <img src="Images/blueg1.jpg" alt="Car Image">
        </div>
        <div class="customization-form">
            <h2>Customize Your Car</h2>
            <form method="post" action="carsmerc1.php">
                ...
                <label for="amg"><input type="checkbox" id="amg" name="amg" value="amg"> AMG Package (+$5,000)</label>
            ...
            <div id="price-tag">Base Price: $150,000</div>
        </div>
    </div>
...
    }
    ...
    const amgPackage = document.getElementById('amg');
    ...
    function changeCarPicture() {
        ...
        if (selectedColor === "red") {
            carImageSrc = "Images/redg1.jpg";
        } else if (selectedColor === "blue") {
            carImageSrc = "Images/blueg1.jpg";
        } else if (selectedColor === "black") {
            carImageSrc = "Images/blackg1.jpg";
        }
...
amgPackage.addEventListener('change', calculatePrice);
